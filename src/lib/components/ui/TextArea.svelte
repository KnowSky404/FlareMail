...
<div class="grid gap-1.5">
  ...
  <textarea
    ...
    class={cn(controlBase, 'fm-touch-target w-full resize-y px-3 py-2 leading-6', error && 'border-red-400 focus-visible:border-red-500 focus-visible:ring-red-500/25', className)}
    {oninput}
  ></textarea>
