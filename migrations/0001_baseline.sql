-- FlareMail D1 baseline (schema.sql as of 2026-08-13).
--
-- Every statement is intentionally IF NOT EXISTS so this baseline can be
-- applied to an empty database or an existing legacy database without
-- replacing tables or deleting rows. Wrangler records the migration as
-- applied; do not edit this file after release.
